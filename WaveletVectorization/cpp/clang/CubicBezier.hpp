...
public:
    List() : vector<T>() {}
    List(size_t n, const T& val = T()) : vector<T>(n, val) {}
    List(const List& list) : vector<T>(list) {}
    List(initializer_list<T> li) : vector<T>(li) {}
...
public:
    ...
    List<double> get_grads(const List<double>& section, int ei, const Point& k, int j, const Point& q, double sign, double left, double right, double bottom, double top)
    {
        ...
        MethodType partial_matrix[][4] = {
            {&CubicBezier::partial_c00_x0,  &CubicBezier::partial_c01_x0,  &CubicBezier::partial_c10_x0,  &CubicBezier::partial_c11_x0},
            {&CubicBezier::partial_c00_y0,  &CubicBezier::partial_c01_y0,  &CubicBezier::partial_c10_y0,  &CubicBezier::partial_c11_y0},
            {&CubicBezier::partial_c00_x1,  &CubicBezier::partial_c01_x1,  &CubicBezier::partial_c10_x1,  &CubicBezier::partial_c11_x1},
            {&CubicBezier::partial_c00_y1,  &CubicBezier::partial_c01_y1,  &CubicBezier::partial_c10_y1,  &CubicBezier::partial_c11_y1},
            {&CubicBezier::partial_c00_x2,  &CubicBezier::partial_c01_x2,  &CubicBezier::partial_c10_x2,  &CubicBezier::partial_c11_x2},
            {&CubicBezier::partial_c00_y2,  &CubicBezier::partial_c01_y2,  &CubicBezier::partial_c10_y2,  &CubicBezier::partial_c11_y2},
            {&CubicBezier::partial_c00_x3,  &CubicBezier::partial_c01_x3,  &CubicBezier::partial_c10_x3,  &CubicBezier::partial_c11_x3},
            {&CubicBezier::partial_c00_y3,  &CubicBezier::partial_c01_y3,  &CubicBezier::partial_c10_y3,  &CubicBezier::partial_c11_y3}
        };
